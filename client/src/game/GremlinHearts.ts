...
function buildHeartProfileShape(): Shape {
  ...
  sh.bezierCurveTo(x, y, x - s * 0.5, y, x - s * 0.5, y + s * 0.25);
  sh.bezierCurveTo(x - s * 0.5, y + s * 0.7, x, y + s * 0.95, x, y + s * 1.4);
  sh.bezierCurveTo(x, y + s * 0.95, x + s * 0.5, y + s * 0.7, x + s * 0.5, y + s * 0.25);
  sh.bezierCurveTo(x + s * 0.5, y, x, y, x, y + s * 0.25);
  return sh;
}
