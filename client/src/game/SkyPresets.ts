...
const DAY_PRESET: SkyPreset = {
  skyGradient: [
    { stop: 0.0, color: "#04102e" },
    { stop: 0.1, color: "#081e4a" },
    { stop: 0.2, color: "#103268" },
    { stop: 0.3, color: "#1a4a82" },
    { stop: 0.4, color: "#266498" },
    { stop: 0.5, color: "#2080b0" },
    { stop: 0.6, color: "#209cc8" },
    { stop: 0.7, color: "#28b8dc" },
    { stop: 0.8, color: "#38d0ea" },
    { stop: 0.9, color: "#50e4f4" },
    { stop: 1.0, color: "#70f2fc" },
  ],
  fogColor: 0x60ccde,
  fogNear: 15,
  fogFar: 40,
